...
plt.plot(Pres_elecs, august_percent_changes, label='August Pre-Election Trend')
plt.xlabel('Election Year')
...
plt.plot(Pres_elecs, september_percent_changes, label='September Pre-Election Trend')
plt.xlabel('Election Year')
...
plt.plot(Pres_elecs, october_percent_changes, label='October Pre-Election Trend')
plt.xlabel('Election Year')
